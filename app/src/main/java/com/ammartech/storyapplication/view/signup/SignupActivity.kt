...
import com.ammartech.storyapplication.databinding.ActivitySignupBinding
                ...
                when (result) {
                    ...
                    is ResultApi.Success -> {
                        ...
                        AlertDialog.Builder(this).apply {
                            setTitle("Success")
                            setMessage("Akun dengan $email sudah berhasil dibuat. Yuk, login dan belajar coding.")
